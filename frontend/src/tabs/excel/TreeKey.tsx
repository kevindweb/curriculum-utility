...
export default function TreeKey() {
    ...
    return (
        <>
            <Typography variant="h5" className={classes.drawerHeader}>Legend (while dragging)</Typography>
            <List dense={true}>
                <ListItem>
                    <KeyBox color={theme.palette.background.paper} borderColor={blueGrey[100]} />
                    <ListItemText primary="Course/Grade Unassigned" />
                </ListItem>
                <ListItem>
                    <KeyBox color="yellow" borderColor={blueGrey[600]} />
                    <ListItemText primary="(Available for Assignment)" />
                </ListItem>
                <ListItem>
                    <KeyBox color={theme.palette.success.light} borderColor={theme.palette.success.dark} />
                    <ListItemText primary="Requirement fullfilled (Acceptable Assignment)" />
                </ListItem>
                <ListItem>
                    <KeyBox color={theme.palette.error.light} borderColor={theme.palette.error.dark} />
                    <ListItemText primary="Error (invalid assignment)" />
                </ListItem>
                <ListItem>
                    <ListItemText primary="IP = 'In Progress'" />
                </ListItem>
                <ListItem>
                    <ListItemText primary="IC = 'Incomplete'" />
                </ListItem>
            </List>
        </>
    );
